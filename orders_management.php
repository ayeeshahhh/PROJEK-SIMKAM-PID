...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['hapus_semua'])) {
    ...
    try {
        ...
        mysqli_query($conn, "DELETE FROM antrian");
        mysqli_query($conn, "DELETE FROM orders");

        
        mysqli_query($conn, "ALTER TABLE antrian AUTO_INCREMENT = 1");

        mysqli_commit($conn);

        $success_message = "Semua pesanan dihapus dan antrian direset ke 1!";
    } catch (Exception $e) {
        mysqli_rollback($conn);
        $error_message = "Gagal menghapus dan reset antrian!";
    }
}
...
$query = "SELECT o.order_id, o.total_harga, o.metode_pembayaran, o.status_orderan, o.created_at,
                 a.antrian_id, a.waktu_pemesanan
          FROM orders o 
            ...
            <div class="col-md-10 p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="btn-group">
                        ...
                        <form method="POST" onsubmit="return confirm('Yakin hapus SEMUA antrian dan pesanan?')" class="d-inline">
                        <button type="submit" name="hapus_semua" class="btn btn-outline-danger">
                            ...
                            <div class="col-md-6 order-item" data-status="<?= $order['status_orderan'] ?>">
                                <div class="order-card <?= $order['status_orderan'] ?> p-3">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <h6 class="mb-0">
                                            Pesanan #<?= $order['antrian_id'] ?: $order['order_id'] ?>
                                        </h6>
